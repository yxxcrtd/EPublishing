...
public class SolrPublicationsIndexService implements PublicationsIndexService {
	...
	public int indexPublications(PPublications publications) throws Exception {
		...
		/*
		 * if(publications.getPissn()!=null&&!"".equals(publications.getPissn().trim
		 * ())){//新加的 pissn 添加完sorl 字段之后解开屏蔽 document.addField("pissn",
	...
	public Map<String, Object> searchByTitle(String title, int pn, int size, Map<String, String> queryParam, String order) throws Exception {
		 ...
		 * .get("taxonomyEn")))){ sb.append(isCn?"(titleCn:":"(title:"); sb.append(title);
		 * sb.append(")"); }else{
		 */
		sb.append("(");
		...
		sb.append(title);
		/*
		 * sb.append(" OR "); sb.append(isCn?"text:":"fullText:"); sb.append(title);
		 */
		sb.append(")");
		/* } */
	...
	public Map<String, Object> searchByAuthor(String author, int pn, int size, Map<String, String> queryParam, String order) throws Exception {
		...
		sb.append(author);
		/*
		 * sb.append(" OR "); sb.append(isCn?"text:":"fullText:"); sb.append(author);
		 */
		sb.append(")");
	...
	public Map<String, Object> searchByISBN(String ISBN, int pn, int size, Map<String, String> queryParam, String order) throws Exception {
		 ...
		 * if((queryParam.get("taxonomy")!=null&&!"".equals(queryParam.get( "taxonomy"
		 * )))||(queryParam.get("taxonomyEn")!=null&&!"".equals(queryParam
		 * .get("taxonomyEn")))){ sb.append("(isbn:"); sb.append(ISBN); sb.append(" OR ");
		 * sb.append("pisbn:"); sb.append(ISBN); sb.append(" OR "); sb.append("hisbn:");
		 * sb.append(ISBN); sb.append(" OR "); sb.append("eissn:"); sb.append(ISBN);
		 * sb.append(")"); }else{
		 */
		sb.append("(");
		sb.append("isbn:");
	...
	public Map<String, Object> searchByPublisher(String publisher, int pn, int size, Map<String, String> queryParam, String order) throws Exception {
		 ...
		 * if((queryParam.get("taxonomy")!=null&&!"".equals(queryParam.get( "taxonomy"
		 * )))||(queryParam.get("taxonomyEn")!=null&&!"".equals(queryParam
		 * .get("taxonomyEn")))){ sb.append(isCn?"(copyPublisherCn:":"(copyPublisher:");
		...
		sb.append(publisher);
		/*
		 * sb.append(" OR "); sb.append(isCn?"text:":"fullText:"); sb.append(publisher);
		 */
		sb.append(")");
		/* } */
	...
	public Map<String, Object> searchByAllFullText(String keywords, int pn, int size, Map<String, String> queryParam, String order) throws Exception {
		...
		sb.append(")");
		/*
		 * }else{ // StringBuffer sb = new StringBuffer(isCn?"titleCn:":"title:");
		 * sb.append(isCn?"titleCn:":"title:"); sb.append(keywords); sb.append(" ");
		 * sb.append(isCn?"remarkCn:":"remark:"); sb.append(keywords); sb.append(" ");
		 * sb.append(isCn?"authorCn:":"author:"); sb.append(keywords); sb.append(" ");
		 * sb.append(isCn?"copyPublisherCn:":"copyPublisher:"); sb.append(keywords);
		 * sb.append(" "); sb.append("isbn:"); sb.append(keywords); sb.append(" ");
		 * sb.append("pisbn:"); sb.append(keywords); sb.append(" "); sb.append("hisbn:");
		 * sb.append(keywords); sb.append(" "); sb.append("eissn:"); sb.append(keywords);
		 * 
		 * 
		 * 
		 * }
		 ...
		 * sb.append(" AND local:"); sb.append(queryParam.get("local")); }
		 */
	...
	private SolrQuery setFacetQuery(SolrQuery query, Map<String, String> queryParam) {
		...
		/*
		//屏蔽：默认前台展示不显示"卷"<类型：6>的信息
		query.addFilterQuery("{!tag=type}NOT type:6");
		*/
	...
	public Map<String, Object> advancedSearch(int curpage, int pageCount, Map<String, String> param, String order, String isChinese) throws Exception {
		...
		// 类型
		/*
		 * if(param.get("type")!=null&&!"".equals(param.get("type"))){ if(flag==0){
		 * sb.append("type:"); flag = 1; }else{ sb.append(" AND type:"); }
	...
	public Map<String, Object> searchNewJournalCn(int pn,int size)throws Exception {
		...
		query.setQuery("type:2 AND (language:chs OR language:中文 OR language:cht) ");
		query.setRequestHandler("/full");
