...
import cn.digitalpublishing.search.ProbationFullTextIndexService;
...
public class SolrProbationInfoIndexService implements ProbationFullTextIndexService {

	private SolrServer solrClient;
	private ServiceFactory serviceFactory;
	private String baseUrl = null;

	public SolrProbationInfoIndexService() {
	...
	public Map<String, Object> searchByAllFullText(String keywords, int pn, int size, Map<String, String> queryParam, String order) throws Exception {
		...
		if (queryParam.get("publisher") != null && !"".equals(queryParam.get("publisher"))) {
			...
			String publisher = queryParam.get("publisher");
			sb.append(" AND ");
			// 左侧链接点击的出版社
			...
			queryParam.put("publisher", "\""+publisher+"\"") ; 
