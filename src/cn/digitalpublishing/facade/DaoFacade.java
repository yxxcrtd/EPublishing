...
import cn.digitalpublishing.dao.EBSourceDao;
...
import cn.digitalpublishing.dao.PEpubAnnotationDao;
import cn.digitalpublishing.dao.PEpubBookmarkDao;
...
public class DaoFacade {
	...
	PEpubAnnotationDao pEpubAnnotationDao;
	
	PEpubBookmarkDao pEpubBookmarkDao;
	...
	public PEpubAnnotationDao getpEpubAnnotationDao() {
		return pEpubAnnotationDao;
	}

	public void setpEpubAnnotationDao(PEpubAnnotationDao pEpubAnnotationDao) {
		this.pEpubAnnotationDao = pEpubAnnotationDao;
	}

	public PEpubBookmarkDao getpEpubBookmarkDao() {
		return pEpubBookmarkDao;
	}

	public void setpEpubBookmarkDao(PEpubBookmarkDao pEpubBookmarkDao) {
		this.pEpubBookmarkDao = pEpubBookmarkDao;
	}

	public EBSourceDao getEbsourceDao() {
		return ebsourceDao;
	}

	public void setEbsourceDao(EBSourceDao ebsourceDao) {
		this.ebsourceDao = ebsourceDao;
	}
