...
import cn.digitalpublishing.springmvc.controller.ViewController;
...
public class PdfHelper {
	public static void main(String[] args) throws Exception {
		...
		files.add("D:/tmp/pdf/978-7-5442-3233-3_chapter_2.pdf");
		files.add("D:/tmp/pdf/978-7-5442-3233-3_chapter_3.pdf");
		files.add("D:/tmp/pdf/978-7-5442-3233-3_chapter_5.pdf");
		mergePdf(files,"D:/tmp/pdf/merged.pdf");
	...
	public static void mergePdf(List<String> files, String savepath)  
    {  
        try   
        {  
