...
public class PPublicationsServiceImpl extends BaseServiceImpl implements PPublicationsService {
	...
	public PPublications getPublications(String id) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.info.get.error", e);// 获取出版物信息失败！
		}
		return obj;
	}
	...
	public List<PPublications> getPubPageList(Map<String, Object> condition, String sort, Integer pageCount,
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.paginglist.get.error",
					e);// 获取出版物分页列表信息失败！
		}
		return list;
	}
	...
	public List<PPublications> getSubscribedPagingList(Map<String, Object> condition, String sort, Integer pageCount,
		...
		List<PPublications> list = null;
		try {
			list = this.daoFacade.getpPublicationsDao().getSubscribedPagingList(condition, sort, pageCount, page, user,
					ip);
		} catch (Exception e) {
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.paginglist.get.error",
	...
	public List<PPublications> getPubSubscriptionPageList(Map<String, Object> condition, String sort, Integer pageCount,
		...
		List<PPublications> list = null;
		try {
			list = this.daoFacade.getpPublicationsDao().getSubscriptionPagingList(condition, sort, pageCount, page,
					user, ip);
		} catch (Exception e) {
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.paginglist.get.error",
	...
	public List<PPublications> getPubList(Map<String, Object> condition, String sort, CUser user, String ip)
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.list.get.error", e);// 获取出版物列表信息失败！
		}
		return list;
	}
	...
	public Integer getPubSubscriptionCount(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.count.get.error", e);// 获取出版物信息总数失败！
		}
		return num;
	}
	...
	public List<PCcRelation> getPccPagingList(Map<String, Object> condition, String sort, int pageCount, int page,
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "pcc.paginglist.get.error", e);// 获取产品包关系信息分页列表失败！
		}
		return list;
	}
	...
	public List<PCcRelation> getPccList(Map<String, Object> condition, String sort, CUser user, String ip)
		...
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt() : "pcc.list.get.error",
					e);// 获取产品包关系信息列表失败！
		}
		return list;
	}
	...
	public int getPccCount(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt() : "pcc.count.get.error",
					e);// 获取产品包关系信息总数失败！
		}
		return num;
	}
	...
	public Integer getPubCollectionCount(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "collection.paginglist.get.error",
					e);// 获取产品包分页信息列表失败！
		}
		return num;
	}
	...
	public List<PCollection> getPubCollectionPageList(Map<String, Object> condition, String sort, Integer pageCount,
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "collection.count.get.error", e);// 获取产品包信息总数失败！
		}
		return list;
	}
	...
	public List<PPublications> getPubCountPageList(Map<String, Object> condition, String sort, Integer pageCount,
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publictions.count.get.error", e);// 获取产品信息总数失败！
		}
		return list;
	}
	...
	public int getPPageCount(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "page.count.get.error", e);// 获取页总数失败！
		}
		return num;
	}
	...
	public PPage getPageByCondition(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt() : "page.info.get.error",
					e);// 获取PDF分页信息失败！
		}
		return page;
	}
	...
	public int getCollectionCount(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "collection.count.get.error", e);// 获取产品包总数失败
		}
		return num;
	}
	...
	public PPrice getPriceByCondition(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "price.info.get.error", e);// 获取出版物价格信息失败！
		}
		return obj;
	}
	...
	public PPrice getPrice(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "price.list.get.error", e);// 获取价格信息列表失败！
		}
		return price;
	}
	...
	public void updateCollection(PCollection obj, String id, String[] properties) throws Exception {
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "collection.info.update.error", e);// 更新产品包信息失败！
		}
	}
	...
	public void insertCollection(PCollection obj) throws Exception {
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "Collection.info.add.error", e);// 添加产品包信息失败！
		}
	}
	...
	public void updateCsRelation(PCsRelation obj, String id, String[] properties) throws Exception {
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "pcs.info.update.error", e);// 更新分类法关系失败！
		}
	}
	...
	public void insertCsRelation(PCsRelation obj) throws Exception {
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt() : "pcs.info.add.error",
					e);// 添加分类法关系失败！
		}
	}
	...
	public void updatePublications(PPublications obj, String id, String[] properties) throws Exception {
		try {
			...
			e.printStackTrace();
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.info.update.error", e);// 更新出版物信息失败！
		}
	}
	...
	public void insertPublications(PPublications obj) throws Exception {
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.info.add.error", e);// 新增出版物信息失败！
		}
	}
	...
	public void updatePrice(PPrice obj, String id, String[] properties) throws Exception {
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "price.info.update.error", e);// 更新价格信息失败！
		}
	}
	...
	public void insertPrice(PPrice obj) throws Exception {
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "price.info.add.error", e);// 新增价格信息失败！
		}
	}
	...
	public void updateCcRelation(PCcRelation obj, String id, String[] properties) throws Exception {
		try {
			...
			PPublications pub = (PPublications) this.daoFacade.getpPublicationsDao().get(PPublications.class.getName(),
					obj.getPublications().getId());
			if (pub != null) {
				pub.setInCollection(
						pub.getInCollection() == null || pub.getInCollection() == 0 ? 0 : (pub.getInCollection() - 1));
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "pcc.info.update.error", e);// 更新产品包关系失败！
		}
	}
	...
	public void insertCcRelation(PCcRelation obj) throws Exception {
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt() : "pcc.info.add.error",
					e);// 新增产品包关系失败！
		}
	}
	...
	public void deletePrice(String id) throws Exception {
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "price.info.delete.error", e);// 删除价格信息失败！
		}
	}
	...
	public PCollection getCollection(Serializable id) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "Collection.info.get.error", e);// 删除产品包信息失败！
		}
		return collection;
	}
	...
	public void deletePccRelaction(Map<String, Object> condition) throws Exception {
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "pcc.info.delete.error", e);// 删除产品包关系信息失败！
		}
	}
	...
	public void deletePcsRelation(String pubId) throws Exception {
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "pcs.info.delete.error", e);// 删除分类法关系信息失败！
		}
	}
	...
	public void deleteChildPublication(Map<String, Object> condition) throws Exception {
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt()
					: "publications.child.info.delete.error", e);// 删除出版物信息失败
		}
	}
	...
	public List<LLicenseIp> getLicenseIpList(Map<String, Object> condition, String sort) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "licenseip.list.get.error", e);// 获取授权IP列表失败
		}
		return list;
	}
	...
	public List<PPublications> getTypeStatistic(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publictions.type.statistic.error",
					e);// 按出版物类型统计失败！
		}
		return list;
	}
	...
	public void generatePages(String id, String basePath) throws Exception {
		...
		try {
			...
			// 查询信息
			PPublications source = (PPublications) this.daoFacade.getpPublicationsDao()
					.get(PPublications.class.getName(), id);
			if (source.getPdf() == null) {
				...
				pdfPath = Param.getParam("pdf.directory.config").get("root") + source.getPublisher().getCode()
						+ Param.getParam("pdf.directory.config").get("detail") + source.getCode()
						+ Param.getParam("pdf.directory.config").get("pdf");
				FileUtil.newFolder(basePath + pdfPath);
				// 将分页转换成swf
				swfPath = Param.getParam("pdf.directory.config").get("root") + source.getPublisher().getCode()
						+ Param.getParam("pdf.directory.config").get("detail") + source.getCode()
						+ Param.getParam("pdf.directory.config").get("swf");
				...
				for (int j = 1; j <= pageCount; j++) {
					...
					String cmd = Param.getParam("pdf.pages.cmd.config").get("win").replace("-", ":") + " \"" + path
							+ "\"" + " -o " + "\"" + basePath + swfPath + "/" + swfName + "\""
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "page.info.generate.error", e);// 生成pdf页面失败
		}
	}
	...
	public List<PPublications> getYearStatistic(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publictions.year.statistic.error",
					e);// 按出版物出版年份统计失败！
		}
		return list;
	}
	...
	public List<PPublications> getPublisherStatistic(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt()
					: "publictions.publisher.statistic.error", e);// 按出版物出版商统计失败！
		}
		return list;
	}
	...
	public List<PPublications> getPPublicationsByISBN(String isbn) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publictions.info.get.error", e);// 获取出版物信息失败！
		}
		return list;
	}
	...
	public List<LLicense> getLicenseList(Map<String, Object> condition, String sort) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "license.list.get.error", e);// 获取授权信息列表失败
		}
		return list;
	}
	...
	public LLicense getLicense(String id) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "license.obj.get.error", e);// 获取授权信息失败
		}
		return obj;
	}
	...
	public PPage getPages(String id) throws Exception {
		...
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt() : "ppage.obj.get.error",
					e);// 获取分页信息失败
		}
		return pPage;
	}
	...
	public List<PCsRelation> getHotPubs(List<PCsRelation> pcslist, Integer number) throws Exception {
		...
		try {
			...
			list = (List<PCsRelation>) this.daoFacade.getpCsRelationDao().getTops(condition,
					" order by p.buyTimes desc ", 5);
		} catch (Exception e) {
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.list.get.error", e);// 获取出版物列表信息失败！
		}
	...
	public Integer getCounterOfRead(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt() : "log.info.get.error",
					e);// 获取日至信息失败！
		}
		return result;
	}
	...
	public List<PPublications> getSimplePagingList(Map<String, Object> condition, String sort, Integer pageCount,
		...
		List<PPublications> list = null;
		try {
			list = (List<PPublications>) this.daoFacade.getpPublicationsDao().getSimplePageList(condition, sort,
					pageCount, page);
		} catch (Exception e) {
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.list.get.error", e);// 获取出版物列表信息失败！
	...
	public List<PPublications> getArticlePagingList(Map<String, Object> condition, String sort, Integer pageCount,
		...
		List<PPublications> list = null;
		try {
			list = this.daoFacade.getpPublicationsDao().getArticlePagingList(condition, sort, pageCount, page, user,
					ip);
		} catch (Exception e) {
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.list.get.error", e);// 获取出版物列表信息失败！
	...
	public List<BInstitution> getLicenseInstitutionList(Map<String, Object> condition, String sort) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "Institution.list.get.error", e);// 获取机构信息失败！
		}
		return list;
	}
	...
	public List<PPublications> getDatabasePageList(Map<String, Object> condition, String sort, Integer pageCount,
		...
		List<PPublications> list = null;
		try {
			list = this.daoFacade.getpPublicationsDao().getDatabasePagingList(condition, sort, pageCount, page, user,
					ip);
		} catch (Exception e) {
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "collection.count.get.error", e);// 获取产品包信息总数失败！
	...
	public List<LComplicating> getComplicatingList(Map<String, Object> condition, String sort) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "complicating.info.list.error", e);// 获取并发列表信息失败！
		}
		return list;
	}
	...
	public void uploads(PPublications obj) throws Exception {
		try {
			...
			if ((pp == null || "".equals(pp.getId())) && obj.getType() == 4) {// 类型
				...
				if(obj.getVolume()!=null&&!"".equals(obj.getVolume())){
			...
			// e.printStackTrace();
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt()
					: "Controller.Publications.Rest.Maintain.Failed", e);// 获取并发列表信息失败！
		}
	}
	...
	public int getDatabaseCount(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "database.count.get.error", e);// 获取数据库信息总数失败！
		}
		return num;
	}
	...
	public List<PCsRelation> getSubStatistic(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "subject.pub..statistic.get.error",
					e);// 获取分类法统计失败！
		}
		return list;
	}
	...
	public List<PPublications> getLicensePubPagingList(Map<String, Object> condition, String sort, Integer pageCount,
		...
		List<PPublications> list = null;
		try {
			list = this.daoFacade.getpPublicationsDao().getLicensePagingList(condition, sort, pageCount, page, user,
					ip);
		} catch (Exception e) {
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.paginglist.get.error",
	...
	public int getLicenseCount(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.count.get.error", e);// 获取信息总数失败！
		}
		return num;
	}
	...
	public LLicense getVaildLicense(PPublications pub, CUser user, String ip) throws Exception {
		...
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "license.info.get.error", e);// 获取信息总数失败！
		}
		return license;
	}
	...
	public List<PPublicationsRelation> getPPublicationsRelationList(Map<String, Object> condition, String sort)
		...
		try {
			...
			// 获取产品信息分页列表失败！
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "Content.data.page.list.error", e);// 获取产品信息分页列表失败！
		}
		return list;
	}
	...
	public BPublisher getPublisher(String id) throws Exception {
		try {
			...
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "Content.data.page.list.error", e);
		}
	...
	@Override
	public List<PPublications> getPublicationsNew(Map<String, Object> condition, String sort, Integer pageCount,
			Integer page) throws Exception {
		List<PPublications> list = null;
		try {
	...
	public List<PCcRelation> getCcLangStatistic(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt()
					: "pcollection.get.lang.statistic.error", e);// 获取产品包内语种统计失败
		}
		return list;
	}
	...
	public List<PCcRelation> getCcTypeStatistic(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt()
					: "pcollection.get.type.statistic.error", e);// 获取产品包内类型统计失败
		}
		return list;
	}
	...
	public List<PCcRelation> getCcTypeLangStatistic(Map<String, Object> condition) throws Exception {
		...
		try {
			...
			throw new CcsException((e instanceof CcsException) ? ((CcsException) e).getPrompt()
					: "pcollection.get.type.lang.statistic.error", e);// 获取产品包内类型语种统计失败
		}
		return list;
	}
	...
	@Override
	public PPublications getPub_probation(Map<String, Object> condition, CUser user, String ip) throws Exception {
		// TODO Auto-generated method stub
		List<PPublications> list = null;
		PPublications pub = null ; 
		try {
			list = this.daoFacade.getpPublicationsDao().getList(condition, " order by a.createOn ", user, ip);
			pub = null!=list && !list.isEmpty() ? list.get(0) : null;
		} catch (Exception e) {
			throw new CcsException(
					(e instanceof CcsException) ? ((CcsException) e).getPrompt() : "publications.list.get.error", e);// 获取出版物列表信息失败！
		}
