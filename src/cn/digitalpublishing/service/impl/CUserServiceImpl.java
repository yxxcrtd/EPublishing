...
public class CUserServiceImpl extends BaseServiceImpl implements CUserService {
	 ...
	 */
	@Override
	public void updateuser(CUser cuser, String id, Object object) throws CcsException {
		try {
			this.daoFacade.getcDirectoryDao().update(cuser, CUser.class.getName(), id, null);
		} catch (Exception e) {
			throw new CcsException((e instanceof CcsException) ? ((CcsException)e).getPrompt()	: "user.info.get.error", e);
		}
