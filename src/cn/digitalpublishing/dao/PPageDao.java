...
public class PPageDao extends CommonDao<PPage, String> {
	...
	public List<PPage> getList(Map<String,Object> condition,String sort)throws Exception{
		...
		String property="png,id,pdf,swf,number,mark,publications.type,publications.publisher.browsePrecent,publications.publisher.downloadPercent,publications.publisher.printPercent,"
				+"publications.publisher.journalBrowse,publications.publisher.journalPrint,publications.publisher.journalDownload,publications.id,publications.oa,publications.free,publications.sourceId";
		String field="a.png,a.id,a.pdf,a.swf,a.number,a.mark,b.type,pp.browsePrecent,pp.downloadPercent,pp.printPercent,pp.journalBrowse,pp.journalPrint,pp.journalDownload,b.id,b.oa,b.free,b.sourceId";
		try{
