...
public class ViewForm extends BaseForm {
	...
	// 2015-09-24 增加是否连续下载设置 1-允许连续打印 2-不允许连续打印 0-默认值 By ruixue.cheng
	private Integer continuousPrint = 0;
	...
	public long getPageEnableNum() {
		return pageEnableNum;
	}

	public void setPageEnableNum(long pageEnableNum) {
		this.pageEnableNum = pageEnableNum;
	}
