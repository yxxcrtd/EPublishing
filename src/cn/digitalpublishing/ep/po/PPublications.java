...
public class PPublications implements java.io.Serializable {
	...
	/**
	 * 试读状态 （临时接值用 0-提供商未设置试读 1-提供商以设置试读）
	 */
	 ...
	 * 出版物的分页信息
	 */
	private String pageNumCount ;  
	
	/**
	 * 提供商 OBJ
	 * @return
	 */
	private EBSource ebSource ; 
	...
	*/
	...
	public PPublications(String id,String title,String cover) {
		super();
		this.id=id;
		this.title=title;
		this.cover=cover;
	}
	public PPublications(String id,String title,String cover,String year,String volumeCode,String issueCode) {
		super();
		this.id=id;
		this.title=title;
		this.cover=cover;
	...
	public void setPageNumCount(String pageNumCount) {
	...
	public EBSource getEbSource() {
		return ebSource;
	}

	public void setEbSource(EBSource ebSource) {
