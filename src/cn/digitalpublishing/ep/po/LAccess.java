...
public class LAccess implements Serializable {
    ...
    /** chensr 20151116添加 客户要求年和月合并字段**/
    private String accessDate; 
    private Integer accessFullType;
	...
	public Integer getAccessFullType() {
		return accessFullType;
	}
	public void setAccessFullType(Integer accessFullType) {
		this.accessFullType = accessFullType;
	}
}
