	...
	<div class="nav">
		<ul>
			...
			<li class="meaudown"
				...
				href="javascript:;"><ingenta-tag:LanguageTag sessionKey="lang"
						key="Page.Frame.Header.Lable.COCTitle" /></a>
				<ul class="cnpeClass">
					<c:if test="${'zh_CN' == sessionScope.lang}">
						<div id="category_zh_CN"></div>
					</c:if>
					<c:if test="${'en_US' == sessionScope.lang}">
						<div id="category_en_US"></div>
					</c:if>
					<div id="category"></div>
			...
			<li class="meaudown"
				...
				href="javascript:void(0)"><ingenta-tag:LanguageTag
						sessionKey="lang" key="Page.Frame.Left.Lable.Publications" /></a>
				<ul>
					<li><a href="${ctx}/pages/publications/readingBookEn"><ingenta-tag:LanguageTag
								sessionKey="lang" key="Pages.Cart.Type.EbookEn" /></a></li>
					<c:if test="${sessionScope.specialInstitutionFlag eq null }">
						<li><a href="${ctx}/pages/publications/readingBook"><ingenta-tag:LanguageTag
									sessionKey="lang" key="Pages.Cart.Type.EbookCn" /></a></li>
						<li><a href="${ctx}/pages/publications/form/index"><ingenta-tag:LanguageTag
									sessionKey="lang" key="Pages.Cart.Type.EjournalEn" /></a></li>
						<li><a href="${ctx}/pages/publications/form/indexCn"><ingenta-tag:LanguageTag 
									sessionKey="lang" key="Pages.Cart.Type.EjournalCn"/></a></li>
						<li><a href="${ctx}/pages/collection/form/prepareManager"><ingenta-tag:LanguageTag
									sessionKey="lang" key="Page.Frame.Header.Lable.Collection" /></a></li>
						<li><a href="${ctx}/pages/collection/form/getPPV"><ingenta-tag:LanguageTag
									sessionKey="lang" key="Pages.Publications.PayPerViewAll" /></a></li>
						<c:if test="${insInfo!=null||(sessionScope.mainUser!=null&&sessionScope.mainUserLevel == 5) }">
							<li><a href="${ctx}/index/probation?pubType=1"><ingenta-tag:LanguageTag
									sessionKey="lang" key="Pages.Publications.Probation" /></a></li>
						</c:if>
					</c:if>
					
					<c:if test="${!(insInfo eq null)}">
						<li><a href="${ctx}/index/advancedSearchSubmit?lcense=1&subFlag=1">
							<ingenta-tag:LanguageTag sessionKey="lang" key="Pages.User.Subscription.Public1" /></a></li>
					</c:if>
