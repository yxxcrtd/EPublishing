...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="main">
			...
			<div class="oh mt10">
				<div class="secLeft">
					...
					<!-- 最新资源 -->
					<!-- <div id="lastPubs" class="resource"></div> -->
					<div class="resource">
						<h1 class="indexHtit">
		...
		<script type="text/javascript" src="${ctx}/js/jquery.cookie.js?${d}"></script>
		...
		function recentlyRead(val) {
			...
			function searchByCondition(type,value,a1,a2,a3,a4){
				if(type=="searchValue"){
					$("#formList input[id='searchValue2']").val(value);
					if(${sessionScope.selectType==1}){
			 			$("#formList input[id='lcense1']").val("1");
				...
				$("#formList input[id='searchsType2']").val(0);
