...
<%@ include file="/common/taglibs.jsp"%>	
			...
			<c:forEach items="${pccList }" var="p" varStatus="index">
				<c:set var="license">${p.publications.inLicense>0||p.publications.insInLicense>0}</c:set>
				...
				<!-- 锁头小图标 -->
					...
					<div class="fl w700">
						...
						<!-- 出版社 -->
						<p><a href='${ctx }/index/search?type=2&isAccurate=1&searchValue="${p.publications.publisherName }"'>${p.publications.publisherName }</a></p>
						<!-- 功能按钮显示 -->
						<c:if test="${sessionScope.mainUser!=null}">
						<p>
							<!-- 未购买 -->
