...
<script type="text/javascript" src="${ctx}/css/skins/default.css"></script>
...
<link href="<%=request.getContextPath()%>/css/pub.css" rel="stylesheet" type="text/css" />
	...
	function GO(obj){
	 ...
	 //这是模态的公共方法
     	function openWindowNew(url,top,left,width,height){
			art.dialog.open( url,{
				title: "个人用户升级专家用户",
				top:100,
				fixed:true,
	...
	function add(){
		var url="<%=request.getContextPath()%>/pages/expertUser/form/exportt";
		var top=document.body.offsetHeigth/2;
		var left=document.body.offsetWIdth/2;
		var width="800px";
		var height="300px";
		openWindowNew(url,top,left,width,height);
	}
	...
	<div class="main personMain" >
		...
		<jsp:include page="/pages/menu?mid=Expertuser&type=2" flush="true" />
			...
			<form:form action="expertManage" method="post" commandName="form" id="form">
				...
				<a style="float:right;" class="orgingB" onclick="add();">+<ingenta-tag:LanguageTag sessionKey='lang' key='Page.Index.Search.Lable.Identity.Expert'/></a>                                      
				</h1>
						  <%-- <div id="u16" class="ax_形状">
					        <img id="u16_img" class="img " src="${ctx}/images/u16.png"/>
					        <div id="u17" class="text">
					          <p><span>+专家</span></p>
					        </div>
					      </div> --%>
					      <!-- 	<p class="mb20 pl20">
					      	    <a onclick="add();" class="orgingB">+专家</a>
								<a class="orgingB"  href=${ctx}/pages/expertUser//form/exportt>+专家</a>
							</p> -->
			       	  <p class="blockP">			       	   
				...
				<!-- <div  class="perRight" id="bb" style="display: none;">
		          <table>
		              <tr>
		                 <td width="120" align="right"><span class="red">*</span> 用户名：&nbsp;</td>
				         <td colspan="3"><input type="text" value="" style="vertical-align:middle" name="account.uid" id="uid"> <span class="red">请指定您的用户名</span></td>
				     </tr>
				</table>
				</div> -->
				<!--定义 0102 左边内容区域 结束-->
